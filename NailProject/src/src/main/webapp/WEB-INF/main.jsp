				...
				<nav class="navbar navbar-expand-lg custom_nav-container ">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav  mx-auto ">
							...
							<li class="nav-item">
								<!-- jstl을 사용하여 세션에 데이터가 있으면 Logout으로 변경 -->
								<c:if test = "${memInfo == null}">
    								<a class="nav-link" href="Gosign.do">Login</a>
								</c:if>
								<c:if test = "${memInfo != null}">
						...
						<div class="user_option">
							<!-- 아이콘은 세션에 데이터가 있으면 마이페이지 없으면 signdo로 이동 -->
							<c:if test = "${memInfo == null}">
    							<a href="Gosign.do" class="user_link">
									<i class="fa fa-user" aria-hidden="true"></i>
								</a>
							</c:if>
							<c:if test = "${memInfo != null}">
								<!-- 아직 마이페이지가 만들어지지 않음 -->
    							<a href="GomyPage.do" class="user_link">
									<i class="fa fa-user" aria-hidden="true"></i>
								</a>
							</c:if>
							
							<a href="design.html" class="order_online">
								Start
							</a>
						</div>
					</div>
		...
		<div class="coment_unit">
			<div class="coment_left">
				<div>
					...
					<span class="comment_title">내 손에 입혀보기
					</span>
				</div>
				<span class="comment_detail">손을 찍어서 업로드만 하면 어떤 디자인이든지 내 손톱에 입혀볼 수 있습니다.
				</span>
			</div>
		...
		<div class="coment_unit">
			<div class="coment_left">
				<div>
					...
					<span class="comment_title">원하는 가게 디자인 찾기
					</span>
				</div>
				<span class="comment_detail">주변에 있는 가게들의 디자인을 거리와 평점순으로 확인이 가능합니다.
				</span>
			</div>
